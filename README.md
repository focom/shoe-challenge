...
I built a webpage using vanillaJS which update in realtime using the websocket feed.
You can also activate notification for low stock.


To test the webpage do the following
